...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your Litestack account",
        description: "Power up your customer management",
        button: "Create Account",
        helper: "Already invited? Use your invite link.",
      };
    }

    return {
      id: "signin",
      title: "Sign in to Litestack",
      description: "Your internal CRM workspace",
      button: "Sign In",
      helper: "Don’t have an account? Contact your admin.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Organize, track, and grow customer relationships with a streamlined CRM.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure auth, polished interface, and a clean onboarding flow built for internal teams.
              </p>
            </div>
          ...
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-between text-xs mt-1">
                <span className="text-muted-foreground">{content.helper}</span>
              </div>
